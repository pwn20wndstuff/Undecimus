...
stage::
	...
	xcodebuild -arch arm64 -sdk iphoneos CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED=NO OTHER_CFLAGS="-DWANT_CYDIA" OTHER_CPLUSPLUSFLAGS="-DWANT_CYDIA" PRODUCT_BUNDLE_IDENTIFIER="fun.apfs.rollectra"
