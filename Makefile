...
all: clean
	xcodebuild clean build CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED=NO PRODUCT_BUNDLE_IDENTIFIER="science.xnu.undecimus" ONLY_ACTIVE_ARCH=NO -sdk iphoneos -configuration Debug -arch arm64 -arch arm64e
