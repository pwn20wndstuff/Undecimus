...
- (IBAction)tappedUicacheLabel:(id)sender{
    UIAlertController *uicacheDefinitionAlert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Refresh Icon Cache", nil) message:NSLocalizedString(@"Forces iOS to show/hide icons of apps that have been added/removed (may fix apps not appearing on your homescreen)", nil) preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *defaultAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"Close", nil) style:UIAlertActionStyleDefault handler:nil];
    [uicacheDefinitionAlert addAction:defaultAction];
    [self presentViewController:uicacheDefinitionAlert animated:TRUE completion:nil];
}

- (IBAction)tappedNonceLabel:(id)sender{
    UIAlertController *nonceDefinitionAlert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Boot Nonce", nil) message:NSLocalizedString(@"A boot nonce generator is used by the system to generate a random, 40-digit hexadecimal called a 'nonce' every time your device boots. When restoring, the nonce generated by your phone must match the nonce in the restore ticket from apple. When using Prometheus for hacked restores, you can find the matching nonce generator in the 'generator' key of your SHSH ticket.", nil) preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *defaultAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"Close", nil) style:UIAlertActionStyleDefault handler:nil];
    [nonceDefinitionAlert addAction:defaultAction];
    [self presentViewController:nonceDefinitionAlert animated:TRUE completion:nil];
}

- (IBAction)tappedDisableRevokes:(id)sender{
    UIAlertController *revokeDefinitionAlert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Disable Revokes", nil) message:NSLocalizedString(@"Blocks your device from detecting that installed Enterprise apps have been revoked by apple (this includes unc0ver, if installed from a signing service). This does not prevent the 7-day expiration of sideloaded applications", nil) preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *defaultAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"Close", nil) style:UIAlertActionStyleDefault handler:nil];
    [revokeDefinitionAlert addAction:defaultAction];
    [self presentViewController:revokeDefinitionAlert animated:TRUE completion:nil];
}

- (IBAction)tappedRec0verLabel:(id)sender {
    UIAlertController *rec0verDefinitionAlert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Restore RootFS (rec0ver)", nil) message:NSLocalizedString(@"Enabling this option will return your device's file system to the state of a backup created immediately before your first jailbreak was completely successfully.", nil) preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *defaultAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"Close", nil) style:UIAlertActionStyleDefault handler:nil];
...
- (IBAction)tappedIncreaseMemLabel:(id)sender {
    UIAlertController *memDefinitionAlert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Increase Memory Limit", nil) message:NSLocalizedString(@"Enabling this option will theoretically delay memory leaks from crashing your system. This is especially useful when using Substitute.", nil) preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *defaultAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"Close", nil) style:UIAlertActionStyleDefault handler:nil];
...
- (IBAction)tappedECIDLabel:(id)sender {
    UIAlertController *ecidDefinitionAlert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"ECID", nil) message:NSLocalizedString(@"Electronic Chip IDentifier is a device-specific hexadecimal used when requesting an APTicket on Apple's servers. Used during any type of restore/upgrade. You need this value if you intend to save SHSH blobs (which allow upgrades to unsigned iOS versions in some circumstances)", nil) preferredStyle:UIAlertControllerStyleAlert];
    ...
    UIAlertAction *blobsInfoAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"More info on saving blobs...", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://redd.it/5lo0dr"] options:@{} completionHandler:nil];
    }];
    ...
    [ecidDefinitionAlert addAction:blobsInfoAction];
...
- (IBAction)tappedOnSystemDaemons:(id)sender {
    UIAlertController *systemDaemonsInfo = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Reload System Daemons", nil) message:NSLocalizedString(@"Restarts all Apple Daemons after jailbreaking (it is highly recommended to enable this)", nil) preferredStyle:UIAlertControllerStyleAlert];
    ...
    [systemDaemonsInfo addAction:okAction];
    [self presentViewController:systemDaemonsInfo animated:TRUE completion:nil];
}
